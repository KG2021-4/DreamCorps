...
import model.VideoC;
import model.Videos;
import view.VideoManagementView;
...
public class ControllerVideoManagement implements ActionListener, WindowListener {
    ...
    private VideoManagementView view;


    public ControllerVideoManagement() {
        videos= new VideoC();
        view = new VideoManagementView(this);
    ...
    private void updateTableModel() {
        ...
        for(Videos video :getVideos().getAll() ) {
...
//	}
    ...
    public VideoManagementView getView() {
        return view;
    }

    public void setView(VideoManagementView view) {
        this.view = view;
    }
